...
public class Member extends User {
 Member(String firstName, String LastName, String id, char gender, String LookingFor, double longitude, double latitude) {
  super(firstName, LastName, id, gender, LookingFor, longitude, latitude, 20);
 ...
 public String nearMeCalc(Data database) {
  ...
  for (int x = 0; x < tempList.size() && x < 20; x++) {
